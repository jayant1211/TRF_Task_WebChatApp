                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                            <div class="selected-user">
                                <span>Me: <span class="name"><?php
						                                    $user = $_SESSION['phone_no'];
                                                            $get_user = "SELECT * from users where phone_no='$user'";
                                                            $run_user = mysqli_query($con, $get_user);
                                                            $row = mysqli_fetch_array($run_user);
                                                            $user_name =$row['user_name'];  echo"$user_name";  ?></span></span>
                            </div>
                            <div id="scrolling_to_bottom" class="chat-container">
                                ...
                                <div class="form-group mt-3 mb-0">
                                    <form method="post">
                                    <input autocomplete="off" class="form-control" name="message" type="text" rows="3" placeholder="Type your message here...">
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($msg=='')
            {
                ...
                <div class='alert alert-danger'>
                    <strong><center>Type something</center></strong>
                </div>";
            }
            else
            {
                $insert = "INSERT INTO users_chat(sender_username,receiver_username,msg_content,msg_status,msg_date) VALUES ('$user_name','$temp_username','$msg','unread',NOW())";
